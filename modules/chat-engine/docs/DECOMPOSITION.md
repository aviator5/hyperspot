...
- **Monitoring & Alerting infrastructure** — deferred to CyberWare middleware-level observability; Chat Engine emits metrics and structured logs but does not own dashboards or alert rules.
