...
* Must align with the established ModKit plugin pattern used across CyberWare
...
* Good, because aligns with ModKit plugin pattern — consistent with other CyberWare modules
