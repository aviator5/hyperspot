...
Universal file storage and management service for the CyberWare middleware.
...
| CyberWare Modules | Any module requiring file operations (e.g., LLM Gateway, document management) |
