...
/// the DESIGN.md Prometheus metric names. The OpenTelemetry SDK (via
...
pub trait MiniChatMetricsPort: Send + Sync {
    ...
    //
    // ## Stream outcome counter invariant (DESIGN.md §5.7)
    //
    ...
    /// `{prefix}_audit_emit_latency_ms` — histogram
...
impl MiniChatMetricsPort for NoopMetrics {
    ...
    fn record_audit_emit_latency_ms(&self, _: f64) {}
