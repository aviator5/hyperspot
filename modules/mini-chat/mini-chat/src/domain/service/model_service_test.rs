...
use crate::domain::service::test_helpers::{
    MockModelResolver, inmem_db, mock_db_provider, mock_enforcer, test_security_ctx,
};
...
fn mock_catalog() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        ModelCatalogEntry {
            ...
            provider_model_id: "disabled-model".to_owned(),
...
async fn build_service(catalog: Vec<ModelCatalogEntry>) -> ModelService {
    ...
    ModelService::new(db, mock_enforcer(), resolver)
}
