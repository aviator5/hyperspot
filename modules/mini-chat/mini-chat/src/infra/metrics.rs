...
/// DESIGN.md Prometheus metric names. The `opentelemetry-prometheus`
...
pub struct MiniChatMetricsMeter {
    ...
    // quota_reserved_tokens{period} gauge: omitted per DESIGN — "only if a pending/reserved concept exists"
