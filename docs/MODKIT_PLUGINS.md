...
This guide explains how to create **plugin-based modules** in Cyber Ware/ModKit. Plugins allow multiple implementations of the same interface to coexist, with the main module selecting the appropriate plugin at runtime based on configuration or
context.
...
- [ARCHITECTURE_MANIFEST.md](./ARCHITECTURE_MANIFEST.md) — Cyber Ware architecture overview
