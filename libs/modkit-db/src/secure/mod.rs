...
//!
//! ```rust
//! use modkit_db::secure::{AccessScope, properties};
//! use uuid::Uuid;
//!
...
//! assert!(resource_scope.has_property(properties::RESOURCE_ID));
//! ```
//!
...
pub use modkit_security::{AccessScope, FilterOp, ScopeConstraint, ScopeFilter, properties};
